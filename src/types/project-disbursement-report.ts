...
export const requireProjectDisbursementReportText = requiredTextWithNamespace(
  'projectDisbursementReport'
);

export const projectDisbursementReportSchema = z.object({
  id: z.number(),
...
export type ProjectDisbursementReport = z.infer<typeof projectDisbursementReportSchema>;

export const defaultValuesProjectDisbursementReport: ProjectDisbursementReport = {
  id: 0, // Khóa chính
