...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.Trigger
    ...
    className={cn(
      ...
      'rounded-none border-t-2 border-transparent bg-white px-[12px] py-[6px] text-[13px] text-gray-600 shadow-none  hover:bg-[rgba(55,154,230,0.08)] data-[state=active]:border-t-2 data-[state=active]:border-[#03A9F4FF] data-[state=active]:text-[#03A9F4FF] data-[state=active]:shadow-none',
      className
    )}
    {...props}
  />
